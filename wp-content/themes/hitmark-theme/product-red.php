<?php
/**
 *  Template Name: W czerwonym stylu
 */
...
if ($ad_field) :
    ...
    ?>
<section class="product_list product_list_ad<?php echo ($content === '') ? ' add_padding' : ''; ?>">
    <div class="container">
        <div class="row">
            <div class="col-12 product_list_all">
                <div class="product_list_item js-open">
                    <div class="product_list_wrap">
                        <div class="product_list_title text_red h3"><?php echo $ad_field_group['dt_nazwa_produktu']; ?>
                        </div>
                    </div>
                    <div class="product_list_btn bg_red"><i class="fal fa-plus"></i></div>
                </div>
                <div class="product_list_desc list_red_dots js-desc">
                    <div class="product_list_desc_flex">
                        <div class="product_list_desc_cont"><?php echo $ad_field_group['dt_opis_produktu']; ?></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 product_list_all">
                <div class="product_list_item  js-open">
                    <div class="product_list_wrap">
                        <div class="product_list_title text_red h3"><?php echo $product['tmp_product_name']; ?></div>
                    </div>
                    <div class="product_list_btn bg_red"><i class="fal fa-plus"></i></div>
                </div>
                <div class="product_list_desc js-desc">
                    <div class="product_list_desc_flex">
                        <div class="product_list_desc_cont list_red_dots "><?php echo $product['tmp_product_desc']; ?>
                        </div>
                        <div class="product_list_desc_line bg_red"></div>
                    </div>
                </div>
...
<section class="product_book">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="product_book_wrap bg_red">
                    <h2 class="product_book_title text_white"><?php the_field('tmp_book_section'); ?></h2>
                    <div class="product_book_link">
                        <?php foreach ($books as $item) : ?>
                        <div class="product_book_link_row">
                            <a class="product_book_item text_white" href="<?php echo $item['tmp_book_link']; ?>">
...
<section class="gallery bg_grey">
    <div class="container container_big">
        <div class="row gallery_title_row">
            <h2 class="gallery_title text_red"><?php the_field('gl_title_block'); ?></h2>
        </div>
        ...
        <div class="row gallery_btn_row">
            <a class="gallery_btn text_red js-show" href="javascript:;"><?php the_field('gl_button_text') ?></a>
        </div>
    </div>
</section>
